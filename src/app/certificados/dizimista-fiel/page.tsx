    ...
    <main className="mx-auto w-full max-w-6xl space-y-6 px-6 py-12 md:px-10 lg:px-16">
      ...
      <Card className="border-border/60 bg-card/80">
        <CardHeader>
          ...
          <CardDescription>Informe o nome e personalize a logo exibida no certificado.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-1">
            <p className="text-sm font-semibold text-foreground">Identidade visual</p>
            <p className="text-xs text-muted-foreground">Use o nome e uma logo customizada (URL ou upload).</p>
          </div>
      ...
      <Card className="border-border/60 bg-card/80">
        ...
        <CardContent>
          <DizimistaFielCertificateBuilder
