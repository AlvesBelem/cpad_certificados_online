...
const CERTIFICATE_TITLE = "Certificado de Apresentação de Crianças (Menina)";
const CERTIFICATE_SLUG = "apresentacao-menina";
    ...
    <div className={cn("relative flex h-full flex-col overflow-hidden text-center", contentPaddingClass)}>
      {showDefaultWatermark ? (
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <Image
            src="/assets/backgrounds/apresentacao-menina/menina.png"
  ...
  return (
    <section className="certificate-print-root flex flex-col gap-6 print:block">
      ...
      <CertificatePreview
        ...
        mobileImage="/certificates/apresentacao-menina/certificado_menina.jpg"
