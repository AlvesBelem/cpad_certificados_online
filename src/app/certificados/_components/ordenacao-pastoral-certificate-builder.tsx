...
const CERTIFICATE_TITLE = "Certificado de Ordenação Pastoral";
const CERTIFICATE_SLUG = "ordenacao-pastoral";
...
function CertificateInner({
  ...
  return (
    <div className="flex h-full flex-col rounded-[32px] bg-white p-6 text-[#6b4b1f] md:p-5">
      ...
      <div className="mt-auto grid gap-6 pt-16 text-center text-xs uppercase tracking-[0.4em] text-muted-foreground md:grid-cols-2">
