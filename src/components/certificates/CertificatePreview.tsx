...
const baseContentClass =
  "certificate-content relative flex h-full w-full flex-col overflow-hidden rounded-[32px] bg-white/75 p-6 text-center md:p-10 print:mx-auto print:my-auto print:h-auto print:w-[94%] print:max-w-[285mm] print:rounded-[32px] print:p-12";
